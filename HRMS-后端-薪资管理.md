...
POST   /api/salary-manage/accounts          # 新建账套（含工资项目）
PUT    /api/salary-manage/accounts/{id}     # 编辑账套
DELETE /api/salary-manage/accounts/{id}     # 删除账套
GET    /api/salary-manage/accounts/{id}     # 账套详情（含工资项目列表）
```
...
PUT    /api/salary-manage/items/{itemId}             # 编辑工资项目
DELETE /api/salary-manage/items/{itemId}             # 删除工资项目
PUT    /api/salary-manage/accounts/{id}/items/sort   # 调整项目排序
```
...
PUT    /api/salary-manage/employee-salaries/{employeeId}   # 更新员工薪资档案
...
GET    /api/salary-manage/batches/{id}/preview     # 预览核算结果（分页）
GET    /api/salary-manage/batches/{id}/anomalies   # 查看异常项
PUT    /api/salary-manage/batches/{id}/adjust      # 手动调整单条薪资
...
```plain
POST   /api/salary-manage/batches/{id}/approve      # 审批通过
POST   /api/salary-manage/batches/{id}/reject       # 驳回（含原因）
```
...
```plain
POST   /api/salary-manage/batches/{id}/mark-paid    # 标记已发放
```
...
```plain
GET    /api/salary-manage/statistics/cost-trend?months=6        # 薪资成本月度趋势折线图
GET    /api/salary-manage/statistics/dept-distribution?month=   # 部门薪资分布柱状图
GET    /api/salary-manage/statistics/composition?month=         # 薪资构成占比饼图
GET    /api/salary-manage/statistics/social-comparison?month=   # 社保公积金对比分组柱状图
GET    /api/salary-manage/statistics/variation-distribution?month= # 薪资变动分布直方图
```
